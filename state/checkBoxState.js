...
export class CheckBoxStateClass extends abstractObjectState {
...
const CheckBoxState = new CheckBoxStateClass({ selectedIds: new Set(), maxCountSelect: 0, countSelected: 0, childCheckboxes: [] });
